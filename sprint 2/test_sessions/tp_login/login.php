<?php
    ...
    if ($_POST) {
				...
				$erroresEnPassword = validarPassword($_POST["contrasena"]);
				...
				$erroresEnMail = validarEmail($_POST["email"]);
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbar-links">
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="../tp_register/register_final2/register.php">Register</a></li>
				</ul>
			</div>
		</div>
	</nav>
            ...
            <form role="form" action="" method="post" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="form-group col-sm-6">
						...
						<input type="contrasena" class="form-control" id="contrasena" name="contrasena" placeholder="Ingrese Contraseña">
					</div>
				</div>
				<div class="checkbox">
					<label>
