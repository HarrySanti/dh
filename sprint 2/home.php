...
<!--Empiezo a controlar el header-->

<!--Si estoy logueado, le muestro el home_login-->
...
<!--Si no estoy logueado le muestro lo de register y signin-->
<?php }else{ ?>
...
<?php }; ?>
		...
		<div class="contenedor">
			...
			<nav>
				<ul>
					<li><a href="tendencias.html" class="nave">TENDENCIAS</a></li><li><a href="hombre.html" class="nave">HOMBRE</a></li><li><a href="mujer.html" class="nave">MUJER</a></li><li><a href="mallas.html" class="nave">MALLAS</a></li><li><a href="faqs.php" class="nave">FAQS</a></li>
				</ul>
			</nav>
